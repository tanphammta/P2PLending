        ...
        public void ToString(StringBuilder sb)
        {
            _innerSnippets.Sort(delegate (InnerSnippet a, InnerSnippet b)
            {
                ...
                throw new InvalidOperationException(
                    $"Internal error: Two snippets have ambigous order. At position from {a.Start} to {a.End}, order1 is {a.Order1}, order2 is {a.Order2}. First snippet is \"{a.Snippet.Text}\", second snippet is \"{b.Snippet.Text}\".");
            });
