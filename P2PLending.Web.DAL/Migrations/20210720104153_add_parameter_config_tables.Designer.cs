...
namespace P2PLending.Web.DAL.Migrations
{
    ...
    [Migration("20210720104153_add_parameter_config_tables")]
    partial class add_parameter_config_tables
    {
            ...
            modelBuilder.Entity("P2PLending.Web.Entities.Entities.Loans.LoanApplication", b =>
                {
                    ...
                    b.HasOne("P2PLending.Web.Entities.Entities.Loans.LoanProduct", "loan_product")
                        .WithMany()
                        .HasForeignKey("loan_productid");

                    b.Navigation("account_mobile");

                    b.Navigation("borrower_profile");

                    b.Navigation("loan_product");
                });
