...
namespace P2PLending.Web.DAL.Migrations
{
    ...
    [Migration("20210723033305_Update_loan_application_validate")]
    partial class Update_loan_application_validate
    {
            ...
            modelBuilder.Entity("P2PLending.Web.Entities.Entities.Loans.LoanProductAdditionalInfo", b =>
                {
                    ...
                    b.Property<int>("loan_product_info")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("P2PLending.Web.Entities.Entities.Loans.LoanProductAdditionalInfo", b =>
                {
                    b.HasOne("P2PLending.Web.Entities.Entities.Loans.LoanProduct", "loan_type")
                        .WithMany()
                        .HasForeignKey("loan_product_info")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
