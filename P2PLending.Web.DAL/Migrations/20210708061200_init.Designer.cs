...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("P2PLending.Web.Entities.Entities.Account.TemporaryOperatorAccount", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("account_operation_temp");
                });
            ...
            modelBuilder.Entity("P2PLending.Web.Entities.Entities.AccountLinkedPayment.MobileLinkedPayment", b =>
                {
                    ...
                    b.Property<string>("service_owner_name")
                        .HasMaxLength(255)
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("P2PLending.Web.Entities.Entities.AddressEntity.Address", b =>
                {
                    ...
                    b.Property<int>("level1_id")
                        .HasColumnType("int");

                    b.Property<int>("level2_id")
                        .HasColumnType("int");

                    b.Property<int>("level3_id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("P2PLending.Web.Entities.Entities.Borrower.BorrowerProfile", b =>
                {
                    ...
                    b.Property<int>("assigned_operator_id")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("workplace_address_id")
                        .IsRequired()
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("P2PLending.Web.Entities.Entities.Loans.LoanApplication", b =>
                {
                    ...
                    b.Property<int?>("borrower_profileid")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("borrower_profileid");

                    b.HasIndex("loan_typeid");
            ...
            modelBuilder.Entity("P2PLending.Web.Entities.Entities.Loans.LoanApplicationAdditionalInfo", b =>
                {
                    ...
                    b.Property<int>("loan_type_additional_info_id")
                        .HasColumnType("int");

                    b.Property<int?>("loan_type_additional_infoid")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("loan_type_additional_infoid");

                    b.ToTable("loan_application_additional_infos");
                });

            modelBuilder.Entity("P2PLending.Web.Entities.Entities.Loans.LoanApplicationAttributeValidate", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("loan_application_attribute_validate");
                });

            modelBuilder.Entity("P2PLending.Web.Entities.Entities.Loans.LoanType", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("type_code")
                        .IsUnique();

                    b.ToTable("loan_types");
                });

            modelBuilder.Entity("P2PLending.Web.Entities.Entities.Loans.LoanTypeAdditionalInfo", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("loan_type_id");

                    b.ToTable("loan_type_additional_info");
                });
            ...
            modelBuilder.Entity("P2PLending.Web.Entities.Entities.Relative.RelativePerson", b =>
                {
                    ...
                    b.Property<string>("relative_person_phone")
                        .HasColumnType("longtext");

                    b.Property<int>("relative_person_type_id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("relative_person_type_id");
            ...
            modelBuilder.Entity("P2PLending.Web.Entities.Entities.Loans.LoanApplication", b =>
                {
                    ...
                    b.HasOne("P2PLending.Web.Entities.Entities.Borrower.BorrowerProfile", "borrower_profile")
                        .WithMany()
                        .HasForeignKey("borrower_profileid");

                    b.HasOne("P2PLending.Web.Entities.Entities.Loans.LoanType", "loan_type")
                        .WithMany()
                        .HasForeignKey("loan_typeid");
            ...
            modelBuilder.Entity("P2PLending.Web.Entities.Entities.Loans.LoanApplicationAdditionalInfo", b =>
                {
                    b.HasOne("P2PLending.Web.Entities.Entities.Loans.LoanApplication", "loan_application")
                        .WithMany("loan_application_additional_infos")
                        .HasForeignKey("loan_application_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("P2PLending.Web.Entities.Entities.Loans.LoanTypeAdditionalInfo", "loan_type_additional_info")
                        .WithMany()
                        .HasForeignKey("loan_type_additional_infoid");

                    b.Navigation("loan_application");

                    b.Navigation("loan_type_additional_info");
                });

            modelBuilder.Entity("P2PLending.Web.Entities.Entities.Loans.LoanApplicationAttributeValidate", b =>
                {
                    b.HasOne("P2PLending.Web.Entities.Entities.Loans.LoanApplication", "loan_application")
                        .WithMany("loan_application_attribute_validates")
                        .HasForeignKey("loan_application_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("P2PLending.Web.Entities.Entities.Relative.RelativePerson", b =>
                {
                    ...
                    b.HasOne("P2PLending.Web.Entities.Entities.MasterData.RelativePersonType", "relative_person_type")
                        .WithMany()
                        .HasForeignKey("relative_person_type_id");
            ...
            modelBuilder.Entity("P2PLending.Web.Entities.Entities.Loans.LoanApplication", b =>
                {
                    b.Navigation("loan_application_additional_infos");

                    b.Navigation("loan_application_attribute_validates");
                });
